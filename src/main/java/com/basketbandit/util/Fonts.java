...
public class Fonts {
    ...
    static {
        try {
            Font font = Font.createFont(Font.TRUETYPE_FONT, Objects.requireNonNull(Fonts.class.getResourceAsStream("/assets/font/balatro/balatro.ttf")));
            default8 = font.deriveFont(8.0f);
            default12 = font.deriveFont(12.0f);
            default16 = font.deriveFont(16.0f);
            default20 = font.deriveFont(20.0f);
